...
const OutlineReviewPhase: React.FC<OutlineReviewPhaseProps> = ({ test, chatHistoryTask1, chatHistoryTask2, targetScore, language, onStartWriting, onOutlinesGenerated }) => {
